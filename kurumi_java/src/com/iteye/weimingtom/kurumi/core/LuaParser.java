...
import com.iteye.weimingtom.kurumi.constant.Reserved;
import com.iteye.weimingtom.kurumi.constant.UnOpr;
import com.iteye.weimingtom.kurumi.model.BlockCnt;
import com.iteye.weimingtom.kurumi.model.CharPtr;
import com.iteye.weimingtom.kurumi.model.ConsControl;
...
import com.iteye.weimingtom.kurumi.model.LHSAssign;
import com.iteye.weimingtom.kurumi.model.LexState;
...
import com.iteye.weimingtom.kurumi.model.Priority;
...
import com.iteye.weimingtom.kurumi.util.ExpKindUtil;
...
public class LuaParser {
	...
	private static void enterblock(FuncState fs, BlockCnt bl, byte isbreakable) { //lu_byte
	...
	public static Proto luaY_parser(LuaStateObject L, ZIO z, Mbuffer buff, CharPtr name) {
...
//						  constructor | FUNCTION body | primaryexp 
	...
	// order 
	// logical (and/or) 
	private static Priority[] priority = { new Priority((byte)6, (byte)6), new Priority((byte)6, (byte)6), new Priority((byte)7, (byte)7), new Priority((byte)7, (byte)7), new Priority((byte)7, (byte)7), new Priority((byte)10, (byte)9), new Priority((byte)5, (byte)4), new Priority((byte)3, (byte)3), new Priority((byte)3, (byte)3), new Priority((byte)3, (byte)3), new Priority((byte)3, (byte)3), new Priority((byte)3, (byte)3), new Priority((byte)3, (byte)3), new Priority((byte)2, (byte)2), new Priority((byte)1, (byte)1) };
...
//		 
	private static BinOpr subexpr(LexState ls, ExpDesc v, int limit) { //uint
...
//		 ** assignment.
//		 
	private static void check_conflict(LexState ls, LHSAssign lh, ExpDesc v) {
		FuncState fs = ls.fs;
	...
	private static void assignment(LexState ls, LHSAssign lh, int nvars) {
