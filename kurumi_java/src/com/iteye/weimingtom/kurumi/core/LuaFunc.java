...
public class LuaFunc {
	...
	public static Closure luaF_newCclosure(LuaStateObject L, int nelems, Table e) {
	...
	public static Closure luaF_newLclosure(LuaStateObject L, int nelems, Table e) {
	...
	public static UpVal luaF_newupval(LuaStateObject L) {
	...
	public static UpVal luaF_findupval(LuaStateObject L, TValue level) { //StkId
	...
	public static void luaF_freeupval(LuaStateObject L, UpVal uv) {
	...
	public static void luaF_close(LuaStateObject L, TValue level) { //StkId
		UpVal uv;
		GlobalState g = LuaState.G(L);
	...
	public static Proto luaF_newproto(LuaStateObject L) {
	...
	public static void luaF_freeproto(LuaStateObject L, Proto f) {
		//UInt32
		//Instruction
	...
	public static void luaF_freeclosure(LuaStateObject L, Closure c) {
