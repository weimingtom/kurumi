...
import com.iteye.weimingtom.kurumi.model.CommonHeader;
...
import com.iteye.weimingtom.kurumi.model.TStringTsv;
...
import com.iteye.weimingtom.kurumi.model.Value;
...
//		 
	...
	public static TStringTsv tsvalue(TValue o) {
	...
	public static UdataUv uvalue(TValue o) {
	...
	public static LuaStateObject thvalue(TValue o) {
		return (LuaStateObject)LuaLimits.check_exp(ttisthread(o), o.value.gc.getTh());
	}
...
//		 
	...
	public static void checkliveness(GlobalState g, TValue obj) {
	...
	public static void setsvalue(LuaStateObject L, TValue obj, GCObject x) {
		obj.value.gc = x;
		obj.tt = Lua.LUA_TSTRING;
		checkliveness(LuaState.G(L), obj);
	}

	public static void setuvalue(LuaStateObject L, TValue obj, GCObject x) {
		obj.value.gc = x;
		obj.tt = Lua.LUA_TUSERDATA;
		checkliveness(LuaState.G(L), obj);
	}

	public static void setthvalue(LuaStateObject L, TValue obj, GCObject x) {
		obj.value.gc = x;
		obj.tt = Lua.LUA_TTHREAD;
		checkliveness(LuaState.G(L), obj);
	}

	public static void setclvalue(LuaStateObject L, TValue obj, Closure x) {
		obj.value.gc = x;
		obj.tt = Lua.LUA_TFUNCTION;
		checkliveness(LuaState.G(L), obj);
	}

	public static void sethvalue(LuaStateObject L, TValue obj, Table x) {
		obj.value.gc = x;
		obj.tt = Lua.LUA_TTABLE;
		checkliveness(LuaState.G(L), obj);
	}

	public static void setptvalue(LuaStateObject L, TValue obj, Proto x) {
		obj.value.gc = x;
		obj.tt = LUA_TPROTO;
		checkliveness(LuaState.G(L), obj);
	}

	public static void setobj(LuaStateObject L, TValue obj1, TValue obj2) {
...
//		 
	...
	public static void setobjs2s(LuaStateObject L, TValue obj, TValue x) {
		setobj(L, obj, x);
	}
	//to stack (not from same stack)

	///#define setobj2s	setobj
	public static void setobj2s(LuaStateObject L, TValue obj, TValue x) {
		setobj(L, obj, x);
	}

	///#define setsvalue2s	setsvalue
	public static void setsvalue2s(LuaStateObject L, TValue obj, TString x) {
		setsvalue(L, obj, x);
	}

	///#define sethvalue2s	sethvalue
	public static void sethvalue2s(LuaStateObject L, TValue obj, Table x) {
		sethvalue(L, obj, x);
	}

	///#define setptvalue2s	setptvalue
	public static void setptvalue2s(LuaStateObject L, TValue obj, Proto x) {
		setptvalue(L, obj, x);
	}

	// from table to same table 
	///#define setobjt2t	setobj
	public static void setobjt2t(LuaStateObject L, TValue obj, TValue x) {
		setobj(L, obj, x);
	}

	// to table 
	///#define setobj2t	setobj
	public static void setobj2t(LuaStateObject L, TValue obj, TValue x) {
		setobj(L, obj, x);
	}

	// to new object 
	///#define setobj2n	setobj
	public static void setobj2n(LuaStateObject L, TValue obj, TValue x) {
		setobj(L, obj, x);
	}

	///#define setsvalue2n	setsvalue
	public static void setsvalue2n(LuaStateObject L, TValue obj, TString x) {
		setsvalue(L, obj, x);
	}
	...
	public static CharPtr svalue(TValue o) { //StkId
...
//		 
	...
	public static int luaO_str2d(CharPtr s, double[] result) { //lua_Number - out
	...
	private static void pushstr(LuaStateObject L, CharPtr str) {
		setsvalue2s(L, L.top, LuaString.luaS_new(L, str));
		LuaDo.incr_top(L);
	}

	// this function handles only `%d', `%c', %f, %p, and `%s' formats 
	public static CharPtr luaO_pushvfstring(LuaStateObject L, CharPtr fmt, Object... argp) {
		int parm_index = 0;
		int n = 1;
		...
		for (;;) {
			...
			switch (e.get(1)) {
				...
				case 'p': {
						...
						LuaConf.sprintf(buff, CharPtr.toCharPtr("0x%08x"), argp[parm_index++].hashCode());
						pushstr(L, buff);
						break;
					}
				case '%': {
	...
	public static CharPtr luaO_pushfstring(LuaStateObject L, CharPtr fmt, Object... args) {
		return luaO_pushvfstring(L, fmt, args);
	}

	public static void luaO_chunkid(CharPtr out_, CharPtr source, int bufflen) { //uint
		//out_ = "";
		if (source.get(0) == '=') {
			LuaConf.strncpy(out_, CharPtr.plus(source, 1), bufflen); // remove first char  - (int)
			...
			if (source.get(0) == '@') {
				...
				// out = [string "string"] 
				int len = LuaConf.strcspn(source, CharPtr.toCharPtr("\n\r")); // stop at first newline  - uint
