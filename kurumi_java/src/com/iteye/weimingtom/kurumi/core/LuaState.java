...
import com.iteye.weimingtom.kurumi.model.LG;
...
public class LuaState {
	// table of globals 
	public static TValue gt(LuaStateObject L) {
		return L.l_gt;
	}

	// registry 
	public static TValue registry(LuaStateObject L) {
	...
	public static Closure curr_func(LuaStateObject L) {
	...
	public static GlobalState G(LuaStateObject L) {
		return L.l_G;
	}

	public static void G_set(LuaStateObject L, GlobalState s) {
		L.l_G = s;
	}
	...
	public static LuaStateObject gco2th(GCObject o) {
		return (LuaStateObject)LuaLimits.check_exp(o.getGch().tt == Lua.LUA_TTHREAD, o.getTh());
	}
...
//		
	...
	public static LuaStateObject tostate(Object l) {
		ClassType.Assert(LuaConf.LUAI_EXTRASPACE == 0, "LUAI_EXTRASPACE not supported");
		return (LuaStateObject)l;
	}

	private static void stack_init(LuaStateObject L1, LuaStateObject L) {
	...
	private static void freestack(LuaStateObject L, LuaStateObject L1) {
...
//		 
	private static void f_luaopen(LuaStateObject L, Object ud) {
		GlobalState g = G(L);
		//UNUSED(ud);
	...
	private static void preinit_state(LuaStateObject L, GlobalState g) {
		G_set(L, g);
		L.stack = null;
		L.stacksize = 0;
		L.errorJmp = null;
	...
	private static void close_state(LuaStateObject L) {
		GlobalState g = G(L);
	...
	//private
	public static LuaStateObject luaE_newthread(LuaStateObject L) {
		//lua_State L1 = tostate(luaM_malloc(L, state_size(typeof(lua_State))));
		LuaStateObject L1 = LuaMem.luaM_new_lua_State(L, new ClassType(ClassType.TYPE_LUA_STATE));
	...
	//private
	public static void luaE_freethread(LuaStateObject L, LuaStateObject L1) {
	...
	public static LuaStateObject lua_newstate(LuaAlloc f, Object ud) {
		int i;
		LuaStateObject L;
		GlobalState g;
	...
	private static void callallgcTM(LuaStateObject L, Object ud) {
		//UNUSED(ud);
	...
	public static void lua_close(LuaStateObject L) {
