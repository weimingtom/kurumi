...
import com.iteye.weimingtom.kurumi.func.LuaLOptDelegate;
import com.iteye.weimingtom.kurumi.func.LuaLOptDelegateInteger;
import com.iteye.weimingtom.kurumi.func.LuaReader;
import com.iteye.weimingtom.kurumi.model.CharPtr;
import com.iteye.weimingtom.kurumi.model.LoadF;
import com.iteye.weimingtom.kurumi.model.LoadS;
...
//		public static void luaL_setn(lua_State L, int t, int n);
	///#else
	public static int luaL_getn(LuaStateObject L, int i) {
		return (int)LuaAPI.lua_objlen(L, i);
	}
	public static void luaL_setn(LuaStateObject L, int i, int j) { // no op! 
	}
	///#endif
...
//		 ** ===============================================================
//		 
	public static void luaL_argcheck(LuaStateObject L, boolean cond, int numarg, String extramsg) {
		if (!cond) {
			luaL_argerror(L, numarg, CharPtr.toCharPtr(extramsg));
		}
	}

	public static CharPtr luaL_checkstring(LuaStateObject L, int n) {
		return luaL_checklstring(L, n);
	}

	public static CharPtr luaL_optstring(LuaStateObject L, int n, CharPtr d) {
		int[] len = new int[1]; //uint
		return luaL_optlstring(L, n, d, len); //out
	}

	public static int luaL_checkint(LuaStateObject L, int n) {
		return luaL_checkinteger(L, n); //(int)
	}

	public static class luaL_checkint_delegate implements LuaLOptDelegateInteger {
		public final int exec(LuaStateObject L, int narg) { //lua_Integer - Int32
			return luaL_checkint(L, narg);
		}
	}

	public static int luaL_optint(LuaStateObject L, int n, int d) { //lua_Integer - Int32
		return luaL_optinteger(L, n, d); //(int)
	}

	public static long luaL_checklong(LuaStateObject L, int n) {
		return luaL_checkinteger(L, n);
	}

	public static long luaL_optlong(LuaStateObject L, int n, int d) { //lua_Integer - Int32
		return luaL_optinteger(L, n, d);
	}

	public static CharPtr luaL_typename(LuaStateObject L, int i) {
	...
	public static void luaL_getmetatable(LuaStateObject L, CharPtr n) {
		LuaAPI.lua_getfield(L, Lua.LUA_REGISTRYINDEX, n);
	}

	public static double luaL_opt(LuaStateObject L, LuaLOptDelegate f, int n, double d) { //lua_Number - lua_Number - Double
		return Lua.lua_isnoneornil(L, (n != 0) ? d : f.exec(L, n)) ? 1 : 0;
	}

	public static int luaL_opt_integer(LuaStateObject L, LuaLOptDelegateInteger f, int n, double d) { //lua_Number - lua_Integer - Int32
...
//		 ** =======================================================
//		 
	public static void luaL_addchar(LuaLBuffer B, char c) {
	...
	// compatibility only
	public static void luaL_putchar(LuaLBuffer B, char c) {
		luaL_addchar(B, c);
	}
...
//		 
	...
	public static int abs_index(LuaStateObject L, int i) {
...
//		 ** =======================================================
//		 
	public static int luaL_argerror(LuaStateObject L, int narg, CharPtr extramsg) {
	...
	public static int luaL_typerror(LuaStateObject L, int narg, CharPtr tname) {
		CharPtr msg = LuaAPI.lua_pushfstring(L, CharPtr.toCharPtr("%s expected, got %s"), tname, luaL_typename(L, narg));
		return luaL_argerror(L, narg, msg);
	}

	private static void tag_error(LuaStateObject L, int narg, int tag) {
		luaL_typerror(L, narg, LuaAPI.lua_typename(L, tag));
	}

	public static void luaL_where(LuaStateObject L, int level) {
		LuaDebugState ar = new LuaDebugState();
	...
	public static int luaL_error(LuaStateObject L, CharPtr fmt, Object... p) {
		luaL_where(L, 1);
	...
	public static int luaL_checkoption(LuaStateObject L, int narg, CharPtr def, CharPtr[] lst) {
	...
	public static int luaL_newmetatable(LuaStateObject L, CharPtr tname) {
	...
	public static Object luaL_checkudata(LuaStateObject L, int ud, CharPtr tname) {
	...
	public static void luaL_checkstack(LuaStateObject L, int space, CharPtr mes) {
		if (LuaAPI.lua_checkstack(L, space) == 0) {
			luaL_error(L, CharPtr.toCharPtr("stack overflow (%s)"), mes);
		}
	}

	public static void luaL_checktype(LuaStateObject L, int narg, int t) {
	...
	public static void luaL_checkany(LuaStateObject L, int narg) {
		if (LuaAPI.lua_type(L, narg) == Lua.LUA_TNONE) {
			luaL_argerror(L, narg, CharPtr.toCharPtr("value expected"));
		}
	}

	public static CharPtr luaL_checklstring(LuaStateObject L, int narg) {
		int[] len = new int[1]; //uint
		return luaL_checklstring(L, narg, len); //out
	}

	public static CharPtr luaL_checklstring(LuaStateObject L, int narg, int[] len) { //uint - out
	...
	public static CharPtr luaL_optlstring(LuaStateObject L, int narg, CharPtr def) {
		int[] len = new int[1]; //uint
		return luaL_optlstring(L, narg, def, len); //out
	}

	public static CharPtr luaL_optlstring(LuaStateObject L, int narg, CharPtr def, int[] len) { //uint - out
	...
	public static double luaL_checknumber(LuaStateObject L, int narg) { //lua_Number - Double
		double d = LuaAPI.lua_tonumber(L, narg); //lua_Number - Double
	...
	public static class luaL_checknumber_delegate implements LuaLOptDelegate {
		public final double exec(LuaStateObject L, int narg) { //lua_Number - Double
			return luaL_checknumber(L, narg);
		}
	}

	public static double luaL_optnumber(LuaStateObject L, int narg, double def) { //lua_Number - lua_Number - Double
		return luaL_opt(L, new luaL_checknumber_delegate(), narg, def);
	}

	public static int luaL_checkinteger(LuaStateObject L, int narg) { //lua_Integer - Int32
		int d = LuaAPI.lua_tointeger(L, narg); //lua_Integer - Int32
		if (d == 0 && LuaAPI.lua_isnumber(L, narg) == 0) { // avoid extra test when d is not 0 
		tag_error(L, narg, Lua.LUA_TNUMBER);
		}
		return d;
	...
	public static class luaL_checkinteger_delegate implements LuaLOptDelegateInteger {
		public final int exec(LuaStateObject L, int narg) { //lua_Integer - Int32
			return luaL_checkinteger(L, narg);
		}
	}

	public static int luaL_optinteger(LuaStateObject L, int narg, int def) { //lua_Integer - Int32 - lua_Integer - Int32
		return luaL_opt_integer(L, new luaL_checkinteger_delegate(), narg, def);
	}

	public static int luaL_getmetafield(LuaStateObject L, int obj, CharPtr event_) {
	...
	public static int luaL_callmeta(LuaStateObject L, int obj, CharPtr event_) {
		obj = abs_index(L, obj);
	...
	public static void luaL_register(LuaStateObject L, CharPtr libname, LuaLReg[] l) {
	...
	public static void luaI_openlib(LuaStateObject L, CharPtr libname, LuaLReg[] l, int nup) {
...
//		}
	...
	public static CharPtr luaL_gsub(LuaStateObject L, CharPtr s, CharPtr p, CharPtr r) {
		CharPtr wild;
	...
	public static CharPtr luaL_findtable(LuaStateObject L, int idx, CharPtr fname, int szhint) {
		CharPtr e;
...
//		 ** =======================================================
//		 
	private static int bufflen(LuaLBuffer B) {
		return B.p;
	}

	private static int bufffree(LuaLBuffer B) {
		return LuaConf.LUAL_BUFFERSIZE - bufflen(B);
	}

	public static final int LIMIT = Lua.LUA_MINSTACK / 2;

	private static int emptybuffer(LuaLBuffer B) {
		int l = bufflen(B); //(uint) - uint
		if (l == 0) {
	...
	private static void adjuststack(LuaLBuffer B) {
		if (B.lvl > 1) {
			LuaStateObject L = B.L;
			int toget = 1; // number of levels to concat 
			int toplen = Lua.lua_strlen(L, -1); //uint
			do {
				int l = Lua.lua_strlen(L, -(toget + 1)); //uint
	...
	public static CharPtr luaL_prepbuffer(LuaLBuffer B) {
		if (emptybuffer(B) != 0) {
			adjuststack(B);
		}
	...
	public static void luaL_addlstring(LuaLBuffer B, CharPtr s, int l) { //uint
		while (l-- != 0) {
			char c = s.get(0);
			s = s.next();
			luaL_addchar(B, c);
	...
	public static void luaL_addstring(LuaLBuffer B, CharPtr s) {
		luaL_addlstring(B, s, LuaConf.strlen(s)); //(uint)
	}

	public static void luaL_pushresult(LuaLBuffer B) {
		emptybuffer(B);
		LuaAPI.lua_concat(B.L, B.lvl);
		B.lvl = 1;
	}

	public static void luaL_addvalue(LuaLBuffer B) {
		LuaStateObject L = B.L;
	...
	public static void luaL_buffinit(LuaStateObject L, LuaLBuffer B) {
		B.L = L;
		B.p = 0; //B.buffer
		B.lvl = 0;
	}
	...
	public static int luaL_ref(LuaStateObject L, int t) {
		int ref_;
		t = abs_index(L, t);
		if (Lua.lua_isnil(L, -1)) {
			Lua.lua_pop(L, 1); // remove from stack 
	...
	public static void luaL_unref(LuaStateObject L, int t, int ref_) {
		if (ref_ >= 0) {
			t = abs_index(L, t);
...
//		 ** =======================================================
//		 
	public static CharPtr getF(LuaStateObject L, Object ud, int[] size) { //uint - out
		size[0] = 0;
		LoadF lf = (LoadF)ud;
		//(void)L;
		if (lf.extraline != 0) {
	...
	private static int errfile(LuaStateObject L, CharPtr what, int fnameindex) {
	...
	public static int luaL_loadfile(LuaStateObject L, CharPtr filename) {
		LoadF lf = new LoadF();
	...
	private static CharPtr getS(LuaStateObject L, Object ud, int[] size) { //uint - out
		LoadS ls = (LoadS)ud;
		//(void)L;
	...
	public static int luaL_loadbuffer(LuaStateObject L, CharPtr buff, int size, CharPtr name) { //uint
		LoadS ls = new LoadS();
	...
	public static int luaL_loadstring(LuaStateObject L, CharPtr s) {
	...
	public static class l_alloc_delegate implements LuaAlloc {
		public final Object exec(ClassType t) {
			return l_alloc(t);
		}
	}

	private static int panic(LuaStateObject L) {
		//(void)L;  /* to avoid warnings */
		LuaConf.fprintf(LuaConf.stderr, CharPtr.toCharPtr("PANIC: unprotected error in call to Lua API (%s)\n"), Lua.lua_tostring(L, -1));
		return 0;
	}

	public static LuaStateObject luaL_newstate() {
		LuaStateObject L = LuaState.lua_newstate(new l_alloc_delegate(), null);
		if (L != null) {
	...
	public static class LuaAuxLib_delegate implements LuaCFunction {
		private String name;
		...
		public final int exec(LuaStateObject L) {
			if ((new String("panic")).equals(name)) {
				return panic(L);
			}
			else {
				return 0;
	...
	public static class getF_delegate implements LuaReader {
		public final CharPtr exec(LuaStateObject L, Object ud, int[] sz) { //uint - out
			return getF(L, ud, sz); //out
		}
	}

	public static class getS_delegate implements LuaReader {
		public final CharPtr exec(LuaStateObject L, Object ud, int[] sz) { //uint - out
