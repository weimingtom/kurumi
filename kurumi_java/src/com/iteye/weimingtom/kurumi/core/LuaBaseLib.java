...
//		 
	private static int luaB_print(LuaStateObject L) {
	...
	private static int luaB_tonumber(LuaStateObject L) {
		...
		if (base_ == 10) {
			...
			n = LuaConf.strtoul(s1, s2, base_); //out
	...
	private static int luaB_error(LuaStateObject L) {
	...
	private static int luaB_getmetatable(LuaStateObject L) {
		LuaAuxLib.luaL_checkany(L, 1);
	...
	private static int luaB_setmetatable(LuaStateObject L) {
	...
	private static void getfunc(LuaStateObject L, int opt) {
		if (Lua.lua_isfunction(L, 1)) {
			...
			if (Lua.lua_isnil(L, -1)) {
				LuaAuxLib.luaL_error(L, CharPtr.toCharPtr("no function environment for tail call at level %d"), level);
			}
		}
	}

	private static int luaB_getfenv(LuaStateObject L) {
		getfunc(L, 1);
	...
	private static int luaB_setfenv(LuaStateObject L) {
		...
		if ((LuaAPI.lua_isnumber(L, 1) != 0) && (LuaAPI.lua_tonumber(L, 1) == 0)) {
			...
			LuaAuxLib.luaL_error(L, CharPtr.toCharPtr(LuaConf.LUA_QL("setfenv") + " cannot change environment of given object"));
		}
		return 1;
	}

	private static int luaB_rawequal(LuaStateObject L) {
		LuaAuxLib.luaL_checkany(L, 1);
	...
	private static int luaB_rawget(LuaStateObject L) {
		LuaAuxLib.luaL_checktype(L, 1, Lua.LUA_TTABLE);
		LuaAuxLib.luaL_checkany(L, 2);
		LuaAPI.lua_settop(L, 2);
	...
	private static int luaB_rawset(LuaStateObject L) {
		LuaAuxLib.luaL_checktype(L, 1, Lua.LUA_TTABLE);
		LuaAuxLib.luaL_checkany(L, 2);
	...
	private static int luaB_gcinfo(LuaStateObject L) {
		LuaAPI.lua_pushinteger(L, Lua.lua_getgccount(L));
		return 1;
	}

	public static final CharPtr[] opts = { CharPtr.toCharPtr("stop"), CharPtr.toCharPtr("restart"), CharPtr.toCharPtr("collect"), CharPtr.toCharPtr("count"), CharPtr.toCharPtr("step"), CharPtr.toCharPtr("setpause"), CharPtr.toCharPtr("setstepmul"), null };

	public final static int[] optsnum = { Lua.LUA_GCSTOP, Lua.LUA_GCRESTART, Lua.LUA_GCCOLLECT, Lua.LUA_GCCOUNT, Lua.LUA_GCSTEP, Lua.LUA_GCSETPAUSE, Lua.LUA_GCSETSTEPMUL };

	private static int luaB_collectgarbage(LuaStateObject L) {
	...
	private static int luaB_type(LuaStateObject L) {
		LuaAuxLib.luaL_checkany(L, 1);
		LuaAPI.lua_pushstring(L, LuaAuxLib.luaL_typename(L, 1));
		return 1;
	}

	private static int luaB_next(LuaStateObject L) {
		LuaAuxLib.luaL_checktype(L, 1, Lua.LUA_TTABLE);
	...
	private static int luaB_pairs(LuaStateObject L) {
		LuaAuxLib.luaL_checktype(L, 1, Lua.LUA_TTABLE);
	...
	private static int ipairsaux(LuaStateObject L) {
	...
	private static int luaB_ipairs(LuaStateObject L) {
		LuaAuxLib.luaL_checktype(L, 1, Lua.LUA_TTABLE);
		LuaAPI.lua_pushvalue(L, Lua.lua_upvalueindex(1)); // return generator, 
		LuaAPI.lua_pushvalue(L, 1); // state, 
	...
	private static int load_aux(LuaStateObject L, int status) {
		if (status == 0) { // OK? 
			return 1;
		}
		else {
	...
	private static int luaB_loadstring(LuaStateObject L) {
	...
	private static int luaB_loadfile(LuaStateObject L) {
...
//		 
	private static CharPtr generic_reader(LuaStateObject L, Object ud, int[] size) { //uint - out
	...
	public static class generic_reader_delegate implements LuaReader {
	...
	private static int luaB_load(LuaStateObject L) {
		int status;
	...
	private static int luaB_dofile(LuaStateObject L) {
		CharPtr fname = LuaAuxLib.luaL_optstring(L, 1, null);
	...
	private static int luaB_assert(LuaStateObject L) {
		LuaAuxLib.luaL_checkany(L, 1);
	...
	private static int luaB_unpack(LuaStateObject L) {
		int i, e, n;
		LuaAuxLib.luaL_checktype(L, 1, Lua.LUA_TTABLE);
	...
	private static int luaB_select(LuaStateObject L) {
		int n = LuaAPI.lua_gettop(L);
	...
	private static int luaB_pcall(LuaStateObject L) {
		int status;
		LuaAuxLib.luaL_checkany(L, 1);
	...
	private static int luaB_xpcall(LuaStateObject L) {
		int status;
		LuaAuxLib.luaL_checkany(L, 2);
		LuaAPI.lua_settop(L, 2);
	...
	private static int luaB_tostring(LuaStateObject L) {
		LuaAuxLib.luaL_checkany(L, 1);
	...
	private static int luaB_newproxy(LuaStateObject L) {
		LuaAPI.lua_settop(L, 1);
	...
	private final static LuaLReg[] base_funcs = { new LuaLReg(CharPtr.toCharPtr("assert"), new LuaBaseLib_delegate("luaB_assert")), new LuaLReg(CharPtr.toCharPtr("collectgarbage"), new LuaBaseLib_delegate("luaB_collectgarbage")), new LuaLReg(CharPtr.toCharPtr("dofile"), new LuaBaseLib_delegate("luaB_dofile")), new LuaLReg(CharPtr.toCharPtr("error"), new LuaBaseLib_delegate("luaB_error")), new LuaLReg(CharPtr.toCharPtr("gcinfo"), new LuaBaseLib_delegate("luaB_gcinfo")), new LuaLReg(CharPtr.toCharPtr("getfenv"), new LuaBaseLib_delegate("luaB_getfenv")), new LuaLReg(CharPtr.toCharPtr("getmetatable"), new LuaBaseLib_delegate("luaB_getmetatable")), new LuaLReg(CharPtr.toCharPtr("loadfile"), new LuaBaseLib_delegate("luaB_loadfile")), new LuaLReg(CharPtr.toCharPtr("load"), new LuaBaseLib_delegate("luaB_load")), new LuaLReg(CharPtr.toCharPtr("loadstring"), new LuaBaseLib_delegate("luaB_loadstring")), new LuaLReg(CharPtr.toCharPtr("next"), new LuaBaseLib_delegate("luaB_next")), new LuaLReg(CharPtr.toCharPtr("pcall"), new LuaBaseLib_delegate("luaB_pcall")), new LuaLReg(CharPtr.toCharPtr("print"), new LuaBaseLib_delegate("luaB_print")), new LuaLReg(CharPtr.toCharPtr("rawequal"), new LuaBaseLib_delegate("luaB_rawequal")), new LuaLReg(CharPtr.toCharPtr("rawget"), new LuaBaseLib_delegate("luaB_rawget")), new LuaLReg(CharPtr.toCharPtr("rawset"), new LuaBaseLib_delegate("luaB_rawset")), new LuaLReg(CharPtr.toCharPtr("select"), new LuaBaseLib_delegate("luaB_select")), new LuaLReg(CharPtr.toCharPtr("setfenv"), new LuaBaseLib_delegate("luaB_setfenv")), new LuaLReg(CharPtr.toCharPtr("setmetatable"), new LuaBaseLib_delegate("luaB_setmetatable")), new LuaLReg(CharPtr.toCharPtr("tonumber"), new LuaBaseLib_delegate("luaB_tonumber")), new LuaLReg(CharPtr.toCharPtr("tostring"), new LuaBaseLib_delegate("luaB_tostring")), new LuaLReg(CharPtr.toCharPtr("type"), new LuaBaseLib_delegate("luaB_type")), new LuaLReg(CharPtr.toCharPtr("unpack"), new LuaBaseLib_delegate("luaB_unpack")), new LuaLReg(CharPtr.toCharPtr("xpcall"), new LuaBaseLib_delegate("luaB_xpcall")), new LuaLReg(null, null) };

	public static class LuaBaseLib_delegate implements LuaCFunction {
		private String name;
...
//		 
	...
	private static int costatus(LuaStateObject L, LuaStateObject co) {
		if (L == co) {
			return CO_RUN;
		}
	...
	private static int luaB_costatus(LuaStateObject L) {
		LuaStateObject co = LuaAPI.lua_tothread(L, 1);
		LuaAuxLib.luaL_argcheck(L, co != null, 1, "coroutine expected");
		LuaAPI.lua_pushstring(L, CharPtr.toCharPtr(statnames[costatus(L, co)]));
		return 1;
	}

	private static int auxresume(LuaStateObject L, LuaStateObject co, int narg) {
	...
	private static int luaB_coresume(LuaStateObject L) {
		LuaStateObject co = LuaAPI.lua_tothread(L, 1);
		int r;
		LuaAuxLib.luaL_argcheck(L, co != null, 1, "coroutine expected");
	...
	private static int luaB_auxwrap(LuaStateObject L) {
		LuaStateObject co = LuaAPI.lua_tothread(L, Lua.lua_upvalueindex(1));
	...
	private static int luaB_cocreate(LuaStateObject L) {
		LuaStateObject NL = LuaAPI.lua_newthread(L);
	...
	private static int luaB_cowrap(LuaStateObject L) {
		luaB_cocreate(L);
		LuaAPI.lua_pushcclosure(L, new LuaBaseLib_delegate("luaB_auxwrap"), 1);
		return 1;
	}

	private static int luaB_yield(LuaStateObject L) {
		return LuaDo.lua_yield(L, LuaAPI.lua_gettop(L));
	}

	private static int luaB_corunning(LuaStateObject L) {
	...
	private final static LuaLReg[] co_funcs = { new LuaLReg(CharPtr.toCharPtr("create"), new LuaBaseLib_delegate("luaB_cocreate")), new LuaLReg(CharPtr.toCharPtr("resume"), new LuaBaseLib_delegate("luaB_coresume")), new LuaLReg(CharPtr.toCharPtr("running"), new LuaBaseLib_delegate("luaB_corunning")), new LuaLReg(CharPtr.toCharPtr("status"), new LuaBaseLib_delegate("luaB_costatus")), new LuaLReg(CharPtr.toCharPtr("wrap"), new LuaBaseLib_delegate("luaB_cowrap")), new LuaLReg(CharPtr.toCharPtr("yield"), new LuaBaseLib_delegate("luaB_yield")), new LuaLReg(null, null) };



	// }====================================================== 

	private static void auxopen(LuaStateObject L, CharPtr name, LuaCFunction f, LuaCFunction u) {
		Lua.lua_pushcfunction(L, u);
		LuaAPI.lua_pushcclosure(L, f, 1);
		LuaAPI.lua_setfield(L, -2, name);
	}

	private static void base_open(LuaStateObject L) {
		// set global _G 
	...
	public static int luaopen_base(LuaStateObject L) {
		base_open(L);
