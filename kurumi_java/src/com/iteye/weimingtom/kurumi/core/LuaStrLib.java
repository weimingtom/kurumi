...
import com.iteye.weimingtom.kurumi.func.LuaStrLibDelegate;
...
import com.iteye.weimingtom.kurumi.model.MatchState;
...
public class LuaStrLib {
	public static int str_len(LuaStateObject L) {
	...
	public static int str_sub(LuaStateObject L) {
		int[] l = new int[1]; //uint
	...
	public static int str_reverse(LuaStateObject L) {
		int[] l = new int[1]; //uint
	...
	public static int str_lower(LuaStateObject L) {
		int[] l = new int[1]; //uint
		int i; //uint
		LuaLBuffer b = new LuaLBuffer();
		CharPtr s = LuaAuxLib.luaL_checklstring(L, 1, l); //out
	...
	public static int str_upper(LuaStateObject L) {
		int[] l = new int[1]; //uint
		int i; //uint
		LuaLBuffer b = new LuaLBuffer();
		CharPtr s = LuaAuxLib.luaL_checklstring(L, 1, l); //out
	...
	public static int str_rep(LuaStateObject L) {
		int[] l = new int[1]; //uint
		LuaLBuffer b = new LuaLBuffer();
		CharPtr s = LuaAuxLib.luaL_checklstring(L, 1, l); //out
	...
	public static int str_byte(LuaStateObject L) {
		int[] l = new int[1]; //uint
		CharPtr s = LuaAuxLib.luaL_checklstring(L, 1, l); //out
	...
	public static int str_char(LuaStateObject L) {
	...
	private static int writer(LuaStateObject L, Object b, int size, Object B, ClassType t) { //uint
		...
		LuaAuxLib.luaL_addlstring((LuaLBuffer)B, (CharPtr)b, size);
		return 0;
	}

	public static class writer_delegate implements LuaWriter {
		public final int exec(LuaStateObject L, CharPtr p, int sz, Object ud) { //uint
			return writer(L, p, sz, ud, new ClassType(ClassType.TYPE_CHARPTR));
		}
	}

	public static int str_dump(LuaStateObject L) {
		LuaLBuffer b = new LuaLBuffer();
...
//		 
	...
	private static int str_find_aux(LuaStateObject L, int find) {
	...
	public static int str_find(LuaStateObject L) {
		return str_find_aux(L, 1);
	}

	public static int str_match(LuaStateObject L) {
		return str_find_aux(L, 0);
	}

	public static int gmatch_aux(LuaStateObject L) {
		MatchState ms = new MatchState();
	...
	public static int gmatch(LuaStateObject L) {
		LuaAuxLib.luaL_checkstring(L, 1);
		LuaAuxLib.luaL_checkstring(L, 2);
		LuaAPI.lua_settop(L, 2);
		LuaAPI.lua_pushinteger(L, 0);
		LuaAPI.lua_pushcclosure(L, new LuaStrLibDelegate("gmatch_aux"), 3);
		return 1;
	}

	public static int gfind_nodef(LuaStateObject L) {
	...
	public static int str_gsub(LuaStateObject L) {
...
//		 
	...
	private static void addquoted(LuaStateObject L, LuaLBuffer b, int arg) {
		int[] l = new int[1]; //uint
	...
	private static CharPtr scanformat(LuaStateObject L, CharPtr strfrmt, CharPtr form) {
		CharPtr p = strfrmt;
	...
	public static int str_format(LuaStateObject L) {
		int arg = 1;
...
//									 keep original string 
	...
	private final static LuaLReg[] strlib = { new LuaLReg(CharPtr.toCharPtr("byte"), new LuaStrLibDelegate("str_byte")), new LuaLReg(CharPtr.toCharPtr("char"), new LuaStrLibDelegate("str_char")), new LuaLReg(CharPtr.toCharPtr("dump"), new LuaStrLibDelegate("str_dump")), new LuaLReg(CharPtr.toCharPtr("find"), new LuaStrLibDelegate("str_find")), new LuaLReg(CharPtr.toCharPtr("format"), new LuaStrLibDelegate("str_format")), new LuaLReg(CharPtr.toCharPtr("gfind"), new LuaStrLibDelegate("gfind_nodef")), new LuaLReg(CharPtr.toCharPtr("gmatch"), new LuaStrLibDelegate("gmatch")), new LuaLReg(CharPtr.toCharPtr("gsub"), new LuaStrLibDelegate("str_gsub")), new LuaLReg(CharPtr.toCharPtr("len"), new LuaStrLibDelegate("str_len")), new LuaLReg(CharPtr.toCharPtr("lower"), new LuaStrLibDelegate("str_lower")), new LuaLReg(CharPtr.toCharPtr("match"), new LuaStrLibDelegate("str_match")), new LuaLReg(CharPtr.toCharPtr("rep"), new LuaStrLibDelegate("str_rep")), new LuaLReg(CharPtr.toCharPtr("reverse"), new LuaStrLibDelegate("str_reverse")), new LuaLReg(CharPtr.toCharPtr("sub"), new LuaStrLibDelegate("str_sub")), new LuaLReg(CharPtr.toCharPtr("upper"), new LuaStrLibDelegate("str_upper")), new LuaLReg(null, null) };

	private static void createmetatable(LuaStateObject L) {
...
//		 ** Open string library
//		 
	public static int luaopen_string(LuaStateObject L) {
