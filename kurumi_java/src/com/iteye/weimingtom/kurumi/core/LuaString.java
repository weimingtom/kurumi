...
import com.iteye.weimingtom.kurumi.model.StringTable;
...
public class LuaString {
	...
	public static TString luaS_new(LuaStateObject L, CharPtr s) {
		return luaS_newlstr(L, s, LuaConf.strlen(s)); //(uint)
	}

	public static TString luaS_newliteral(LuaStateObject L, CharPtr s) {
		return luaS_newlstr(L, s, LuaConf.strlen(s)); //(uint)
	}
	...
	public static void luaS_resize(LuaStateObject L, int newsize) {
		GCObject[] newhash;
		StringTable tb;
		int i;
	...
	public static TString newlstr(LuaStateObject L, CharPtr str, int l, long h) { //uint - int - uint
		TString ts;
		StringTable tb;
	...
	public static TString luaS_newlstr(LuaStateObject L, CharPtr str, int l) { //uint
		GCObject o;
		//FIXME:
	...
	public static Udata luaS_newudata(LuaStateObject L, int s, Table e) { //uint
		Udata u = new Udata();
	...
	public static Udata luaS_newudata(LuaStateObject L, ClassType t, Table e) {
		Udata u = new Udata();
		u.uv.marked = LuaGC.luaC_white(LuaState.G(L)); // is not finalized 
		u.uv.tt = Lua.LUA_TUSERDATA;
		u.uv.len = 0;
