...
public class LuaLex {
	...
	public static void luaX_init(LuaStateObject L) {
		int i;
	...
	public static void luaX_setinput(LuaStateObject L, LexState ls, ZIO z, TString source) {
		ls.decpoint = '.';
		ls.L = L;
