...
import com.iteye.weimingtom.kurumi.core.LuaObject;
...
public class GlobalState {
	...
	public LuaAlloc frealloc; // function to reallocate memory 
 ...
 //lu_byte
  // state of garbage collector 
	...
	public LuaCFunction panic; // to be called in unprotected errors 
	public TValue l_registry = new TValue();
	public LuaStateObject mainthread;
